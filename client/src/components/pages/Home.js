	...
	return (
		<div className='container home-container'>
			...
			<div className='home-upcoming'>
				...
				<p className='lead-sm my-1'>
					<strong>
						Woody De Othello. <em>Jigsaw Puzzle.</em>
					</strong>{' '}
					Available in December 2020.
				</p>
				<p>
					5 original color images by Woody De Othello (with 3 puzzles per
					image). Co-published by RITE Editions, Jessica Silverman Gallery, San
					Francisco, Karma Gallery, New York. In collaboration with Mark A.
					Rodriguez and Soulfrawg Puzzles. 2020. Maximum dimensions: 10 x 12”.{' '}
				</p>
				<p>Approximately 150 pieces.</p>
				<p>Edition of 15.</p>
				<p>
					*Pre-orders available. Submit your order on the <em>Inquiry</em> page.
				</p>
				<br />
				<p>
					The limited edition jigsaw puzzle will have hand cut wooden pieces;
					each puzzle will be unique. The puzzles are intended to be
					challenging. They will be in the tradition of jigsaws that have no
					guiding images.{' '}
				</p>
				<p className='lead-sm my-1'>
