    ...
    <div className="about">
      <div className="container">
        ...
        <p>
          ...
          Making by Jonathan Monk, an LP recording referencing Robert Morris’s
          Box with the Sound of Its Own Making (1961). Subsequent multiples
          include The White Album by Mungo Thomson (2009), Travis Meinolf’s
          Social Fabric Berlin Mitte (2010), and Paul Sietsema’s At the hour of
          tea (2014). This year, three editions will be published: Davina Semo’s
          Letter Opener, 2019, a monograph entitled Steven Leiber Catalogs, and
          an edition by Carissa Potter.
        </p>
        <br />
        <p>
